AFRAME.registerComponent("pose-me-target", {
    init: function () {
        ...
        const updateAttribute = function () {
            ...
            bubble.setAttribute("look-at", "#cam");
            ...
            circle.setAttribute(
                "animation",
                "property: position;from:0 4 0; to: 0 -2 0; loop:true; dur:" +((1050*Math.random()) + 3750)+";direction:alternate; easing:linear; "
            );
        };
    ...
    tick: function (){
        let circle = this.el.querySelector("a-plane");
